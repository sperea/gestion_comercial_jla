...
export async function GET(request: NextRequest) {
  try {
    console.log('🔄 [PROXY INTRANET] Iniciando proxy para columnas-comparativo-default');
    ...
    const intranetUrl = new URL(`${INTRANET_API_URL}/api/columnas-comparativo-default/`);
