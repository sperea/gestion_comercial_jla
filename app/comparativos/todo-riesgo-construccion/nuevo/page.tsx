...
export default function NuevoProyectoTodoRiesgoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/comparativos/todo-riesgo-construccion/${newProject.id}`)
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Nuevo Proyecto Todo Riesgo Construcción</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Input
            ...
            value={formData.obra}
            onChange={handleChange}
            placeholder="Ej: Edificio Residencial Torre Norte"
            required
          />
          ...
          <div className="flex justify-end pt-4 space-x-3">
             <Link href="/comparativos/todo-riesgo-construccion">
